...
public class Details {
    ...
    public String toString() {
        return "\t\t Leírás: " + description + System.lineSeparator() +
                "\t\t Ingatlan alapterülete: " + squareMeter + " m2" + System.lineSeparator() +
                "\t\t Telek alapterülete   : " + areaOfSite + "m2" + System.lineSeparator() +
                "\t\t Cím: " + address.toString();
    }
}
